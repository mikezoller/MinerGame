    ...
    SubShader
    {
			...
			float CorrectDepth(float rawDepth)
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float existingDepth01 = tex2Dproj(_CameraDepthTexture, UNITY_PROJ_COORD(i.screenPosition)).r * 40;
				// Convert the depth from non-linear 0...1 range to linear
				// depth, in Unity units.
				float existingDepthLinear = CorrectDepth(LinearEyeDepth(existingDepth01));
